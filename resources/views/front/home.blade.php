    ...
    <div class="container page__container py-64pt py-md-112pt">
        <div class="row align-items-center text-center text-md-left">
            <div class="col-md-6 col-lg-5 order-1 order-md-0">
                <h1 class="text-white">Bienvenue sur Burn
                    {{-- <span class="text-scramble js-text-scramble">Bliss</span> --}}
                </h1>
                <p class="lead mb-48pt text-white">Business, Technology and Creative Skills taught by
                    industry experts. Explore a wide range of skills with our professional tutorials.
                </p>
                <a href="library.html" class="btn btn-lg btn-white btn--raised mb-16pt">Liste des cours</a>
                {{-- <p><a href="#" class="text-white-70 text-underline"><strong>Are you a
                            teacher?</strong></a></p> --}}
            </div>
            <div class="col-md-6 col-lg-7 order-0 order-md-1 text-center mb-32pt mb-md-0">
                <img src="{{asset('template/assets/images/macbook.png')}}" alt="macbook" class="home-macbook">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row align-items-center">
        <div
            ...
            <div class="flex">
                ...
                <p class="text-black-70">Explore a wide range of skills.</p>
            </div>
        </div>
        <div
            class="d-flex col-md align-items-center border-bottom border-md-0 mb-16pt mb-md-0 pb-16pt pb-md-0">
            ...
            <div class="flex">
                ...
                <p class="text-black-70">Professional development from the best people.</p>
            </div>
        </div>
        <div class="d-flex col-md align-items-center">
            ...
            <div class="flex">
                ...
                <p class="text-black-70">Unlock Library and learn any topic with one subscription.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row align-items-end mb-16pt mb-md-32pt">
        ...
        <div class="col-md text-center text-md-right d-flex justify-content-md-end align-items-center flex-wrap"
            ...
            <a href="library-development.html"
                class="chip mb-16pt mb-md-0 chip-secondary">Development</a>
            <a href="library-development.html"
                class="chip mb-16pt mb-md-0 chip-outline-secondary">Design</a>
            <a href="library-development.html"
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="center">
                    <img src="{{asset('template/assets/images/paths/angular_430x168.png')}}" alt="course">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                ...
                                <small class="text-black-50 font-weight-bold mb-4pt">Elijah
                                    Murray</small>
                            </div>
                            <a href="course.html"
                                class="ml-4pt material-icons text-black-20 card-course__icon-favorite">favorite</a>
                        </div>
                        <div class="d-flex">
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left">
                        <img src="{{asset('template/assets/images/paths/angular_40x40.svg')}}" alt="Angular" class="rounded">
                    </div>
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Learn Angular fundamentals</div>
                        <p class="lh-1">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="center">
                    <img src="{{asset('template/assets/images/paths/swift_430x168.png')}}" alt="course">
                    <span class="overlay__content">
                        <span class="overlay__action d-flex flex-column text-center">
                            <i class="material-icons">play_circle_outline</i>
                            <small>Preview course</small>
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left">
                        <img src="{{asset('template/assets/images/paths/swift_40x40.svg')}}" alt="Angular" class="rounded">
                    </div>
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Build an iOS Application in Swift</div>
                        <p class="lh-1">
                            <span class="text-black-50 small">with</span>
                            <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                        </p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="center">
                    <img src="{{asset('template/assets/images/paths/wordpress_430x168.png')}}" alt="course">
                    <span class="overlay__content">
                        <span class="overlay__action d-flex flex-column text-center">
                            <i class="material-icons">play_circle_outline</i>
                            <small>Preview course</small>
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left">
                        <img src="{{asset('template/assets/images/paths/wordpress_40x40.svg')}}" alt="Angular"
                            class="rounded">
                    </div>
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Build a WordPress Website</div>
                        <p class="lh-1">
                            <span class="text-black-50 small">with</span>
                            <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                        </p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="left">
                    <img src="{{asset('template/assets/images/paths/react_430x168.png')}}" alt="course">
                    <span class="overlay__content">
                        <span class="overlay__action d-flex flex-column text-center">
                            <i class="material-icons">play_circle_outline</i>
                            <small>Preview course</small>
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left">
                        <img src="{{asset('template/assets/images/paths/react_40x40.svg')}}" alt="Angular" class="rounded">
                    </div>
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Become a React Native Developer</div>
                        <p class="lh-1">
                            <span class="text-black-50 small">with</span>
                            <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                        </p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="center">
                    <img src="{{asset('template/assets/images/paths/redis_430x168.png')}}" alt="course">
                    <span class="overlay__content">
                        <span class="overlay__action d-flex flex-column text-center">
                            <i class="material-icons">play_circle_outline</i>
                            <small>Preview course</small>
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left">
                        <img src="{{asset('template/assets/images/paths/redis_40x40.svg')}}" alt="Angular" class="rounded">
                    </div>
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Become a Redis Developer</div>
                        <p class="lh-1">
                            <span class="text-black-50 small">with</span>
                            <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                        </p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="left">
                    <img src="{{asset('template/assets/images/paths/typescript_430x168.png')}}" alt="course">
                    <span class="overlay__content">
                        <span class="overlay__action d-flex flex-column text-center">
                            <i class="material-icons">play_circle_outline</i>
                            <small>Preview course</small>
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left">
                        <img src="{{asset('template/assets/images/paths/typescript_40x40.svg')}}" alt="Angular"
                            class="rounded">
                    </div>
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Introduction to Typescript</div>
                        <p class="lh-1">
                            <span class="text-black-50 small">with</span>
                            <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                        </p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="center">
                    <img src="{{asset('template/assets/images/paths/devops_430x168.png')}}" alt="course">
                    <span class="overlay__content">
                        <span class="overlay__action d-flex flex-column text-center">
                            <i class="material-icons">play_circle_outline</i>
                            <small>Preview course</small>
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left">
                        <img src="{{asset('template/assets/images/paths/devops_40x40.svg')}}" alt="Angular" class="rounded">
                    </div>
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Become a DevOps Engineer</div>
                        <p class="lh-1">
                            <span class="text-black-50 small">with</span>
                            <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                        </p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal "
                ...
                <a href="course.html" class="js-image" data-position="left">
                    <img src="{{asset('template/assets/images/paths/angular_testing_430x168.png')}}" alt="course">
                    <span class="overlay__content">
                        <span class="overlay__action d-flex flex-column text-center">
                            <i class="material-icons">play_circle_outline</i>
                            <small>Preview course</small>
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    ...
                    <div class="media-body">
                        <div class="card-title text-body mb-0">Angular Unit Testing</div>
                        <p class="lh-1">
                            <span class="text-black-50 small">with</span>
                            <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                        </p>
...
<div class="container page__container">
    <div class="page-headline text-center">
        ...
        <p class="lead text-black-70 measure-lead mx-auto">Stop guessing what to learn next and start
            making progress faster based on your current skill level and experience.</p>
    </div>
    ...
    <div class="row mt-16pt mt-lg-32pt">
        ...
        <div class="col-i8-6 col-md-3 mb-16pt">
            <a href="path.html" class="media">
                <img src="{{asset('template/assets/images/paths/react_40x40.png')}}" alt="React Native"
                    class="media-left rounded">
                <span class="media-body">
        ...
        <div class="col-i8-6 col-md-3 mb-16pt">
            <a href="path.html" class="media">
                <img src="{{asset('template/assets/images/paths/swift_40x40.png')}}" alt="Swift" class="media-left rounded">
                <span class="media-body">
        ...
        <div class="col-i8-6 col-md-3 mb-16pt">
            <a href="path.html" class="media">
                <img src="{{asset('template/assets/images/paths/wordpress_40x40.png')}}" alt="WordPress"
                    class="media-left rounded">
                <span class="media-body">
        ...
        <div class="col-i8-6 col-md-3 mb-16pt">
            <a href="path.html" class="media">
                <img src="{{asset('template/assets/images/paths/devops_40x40.png')}}" alt="Development Tools"
                    class="media-left rounded">
                <span class="media-body">
...
<div class="container page__container">
    <div class="page-headline text-center">
        <h2>Feedback</h2>
        <p class="lead measure-lead mx-auto text-black-70">What other students turned professionals have
            to say about us after learning with us and reaching their goals.</p>
    </div>
            ...
            <div class="col-12 col-md-6">
                <div class="card card--elevated card-body">
                    <blockquote class="mb-0">
                        <p class="text-black-70">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Quia distinctio reiciendis iusto id, doloribus optio soluta laborum
                            nobis dolor tempore velit porro maiores eveniet voluptas officia ipsa magnam
                            aliquam. Perferendis?</p>

                        <div class="media">
                            <div class="media-left">
                                <img src="{{asset('template/assets/images/people/110/guy-1.jpg')}}" width="40" alt="avatar"
                                    class="rounded-circle">
                            </div>
                            <div class="media-body media-middle">
                                <p class="mb-0"><a href="#" class="text-body"><strong>Umberto
                                            Kass</strong></a></p>
                                <div class="rating">
                                    <span class="rating__item"><span
                                            class="material-icons">star</span></span>
            ...
            <div class="col-12 col-md-6">
                <div class="card card--elevated card-body">
                    <blockquote class="mb-0">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img src="{{asset('template/assets/images/people/110/guy-2.jpg')}}" width="40" alt="avatar"
                                    class="rounded-circle">
                            </div>
                            <div class="media-body media-middle">
                                <p class="mb-0"><a href="#" class="text-body"><strong>Umberto
